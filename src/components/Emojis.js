...
function Emojis() {
  return (
    <>
      <h1>This is the first base Emojis list</h1>
      <p>
        ...
        La Leche
        <br />
        <span role="img" aria-label="onion">
          🧅
        </span>
        La Cebolla
        <br />
        ...
        El Maíz
        <br />
        <span role="img" aria-label="cucumber">
          🥒
        </span>
        El Pepino
        <br />
        ...
        El Ajo
        <br />
        <span role="img" aria-label="hot pepper">
          🌶️
        </span>
        El Chile
        <br />
        <span role="img" aria-label="red apple">
          🍎
        </span>
        La Manzana Roja
        <br />
        <span role="img" aria-label="green apple">
          🍏
        </span>
        La Manzana Verde
        <br />
        ...
        El Limon
        <br />
        <span role="img" aria-label="oyster">
          🦪
        </span>
        El Ostra
        <br />
